...
namespace TerraUI.Objects {
    public class UIFakeItemSlot : UIObject {
        protected Item item;
        ...
        public UIFakeItemSlot(Vector2 position, int size = 52, Contexts context = Contexts.InventoryItem, UIObject parent = null,
        ...
        public override void DefaultLeftClick() {
			//item = Main.player[Main.myPlayer].item
            Recipe.FindRecipes();
        }
